...
* **🔍 Otomatik Güvenlik Analizi:** Reentrancy, Integer Overflow/Underflow, Access Control eksiklikleri gibi kritik açıkları tespit eder.
* **📊 Risk Puanlama Sistemi:** Kontratın güvenliğini 0-100 arasında puanlar.
* **💡 Akıllı İyileştirme Önerileri:** Tespit edilen hataların nasıl düzeltileceğini gösterir ve kodun "güvenli" halini üretir.
* **⚡ Hızlı ve Ücretsiz:** Off-chain (zincir dışı) çalıştığı için gas fee ödemeden saniyeler içinde sonuç verir.
* **💻 Kullanıcı Dostu Arayüz:** React tabanlı modern bir arayüz ile kodunuzu kolayca yapıştırıp analiz edebilirsiniz.
